...
export const data = [
	{
		...
		moreDetails: entities.decode('&#8220;') + 'Allah SAW will inevitably test His believing servants according to their level of faith. The people most severely tested are the Prophets, then the righteous, then the next best and the next best. A man will be tested in accordance with the degree of his religious commitment; the stronger his religious commitment, the stronger his test.' + entities.decode('&#8221;')
	},
	{
		id: 2,
		title: "Quran (65:3)",
	...
	},
	{
		...
		moreDetails: entities.decode('&#8220;') + 'O you who believe! Avoid much suspicions, indeed some suspicions are sins. And spy not, neither backbite one another. Would one of you like to eat the flesh of his dead brother? You would hate it (so hate backbiting). And fear Allah. Verily, Allah is the One Who accepts repentance, Most Merciful.' + entities.decode('&#8221;')
	}
]