...
export const allChapter = [
	...
	},
	{
		...
		showMessage: true, 
		message: 'The basic 28 arabic letters change their shape according to their position in a word.',
		bgColor: '#60a3bc',
		active: true,
		img: require('../../assets/img/badges/chapter8.png'),
		details: 'The basic 28 arabic letters change their shape according to their position in a word.',
	},
	{ 
		id: 'chapter9',
	...
	{ 
		...
		active: false,
		img: require('../../assets/img/badges/chapter13.png'),
		details: 'Shaddah is a small "w"-like symbol placed above a letter. It denotes a stress on the letter placed. For example, ' + Utils.codeToArabic('&#1576;&#1614;&#1578;&#64610;') + ' is pronounced as atta instead of ata.',
	},
	{ 
		id: 'chapter15',
		data: Generate.generateChapter(Shaddah.ARABIC_TWO_LETTER_SHADDAH, 'chapter14', 7),
