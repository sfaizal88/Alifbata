...
import { StyleSheet, Text, View , SafeAreaView, Image, StatusBar, ScrollView, FlatList } from 'react-native';
...
export const HeadsupScoreScreen = ({ navigation, route }) => {
        	...
        	<ScrollView style={[styles.body, styles.p0, styles.pb15, styles.pt20]}  contentContainerStyle={[styles.centerView, styles.column]}>
	        	<View>
					...
					<View style={[styles.slideImageContainer, styles.rowDirection]}>
						<Button onPress={() => _navigate('GameList', {params: { slideIndex: 1 }})} icon={<Icon name={'refresh'} size={RFValue(18)} color={Colors.grayDarkest} type='font-awesome'/>}
