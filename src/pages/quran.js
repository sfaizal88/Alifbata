...
import { RefreshControl, StyleSheet, Text, View , FlatList, TouchableHighlight } from 'react-native';
...
export const QuranScreen = ({ navigation }) => {
	...
	useEffect(() => {
		...
		navigation.addListener('focus', () => {
			...
			navigation.setOptions({ title: 'Quran' });
    ...
    */
	...
	return (
		<>
	    	...
	    	<MHeader title="Quran" icon="group"/>
